...
WHERE TIMESTAMPDIFF(day,(SELECT MAX(end_time)) FROM tb_user_video_log),l.end_time) < 30注意
WHERE TIMESTAMPDIFF(day,(SELECT MAX(end_time)) FROM tb_user_video_log),l.end_time) < 30亮点
WHERE TIMESTAMPDIFF(day,(SELECT MAX(end_time)) FROM tb_user_video_log),l.end_time) < 30
